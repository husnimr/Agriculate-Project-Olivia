    ...
    if (ubah($_POST) > 0) {
        ...
        echo "
            <script>
                ...
                document.location.href = 'ubah-artikel.php?id=$id'; // tambahkan kembali ke halaman ubah jika gagal
            </script>
        ";
    }
}
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4><?php echo isset($artikel) ? 'Ubah' : 'Tulis'; ?> Artikel</h4>
                  </div>
                  <div class="card-body">
                  <form method="POST" enctype="multipart/form-data" action="">
                  <input type="hidden" name="id" value="<?php echo isset($artikel) ? $artikel['id'] : ''; ?>">
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Judul</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="text" id="judul" name="judul" class="form-control" value="<?php echo isset($artikel) ? $artikel['judul'] : ''; ?>">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Penulis</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="text" id="penulis" name="penulis" class="form-control" value="<?php echo isset($artikel) ? $artikel['penulis'] : ''; ?>" readonly>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <textarea class=" " id="isiartikel" name="konten"><?php echo isset($artikel) ? $artikel['konten'] : ''; ?></textarea>
                      </div>
                    </div>
                    <input type="hidden" name="gambarLama" value="<?php echo $artikel['gambar']; ?>">
                    <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <button type="submit" name="submit" class="btn btn-primary"><?php echo isset($artikel) ? 'Ubah' : 'Posting'; ?></button>
