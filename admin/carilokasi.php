...
<head>
  ...
  <title>Cari Lokasi - Agriculate</title>
  <!-- General CSS Files -->
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              <div class="dropdown-title">Hai, Husni</div>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <a class="nav-link" href="carilokasi.php"><i data-feather="map-pin"></i><span>Cari Lokasi</span></a>
            </li>
                    ...
                    <div class="row mb-4">
                      <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                          <input type="text" class="form-control" id="input-lat" placeholder="Latitude" value="106.8007164">
                          <input type="text" class="form-control" id="input-lng" placeholder="Longitude" value="-6.5984847">
                        </div>
                      </div>
                    </div>
