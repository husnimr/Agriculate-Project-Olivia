...
// Ambil nama admin dari database berdasarkan username yang telah login
$username = $_SESSION['username'];
$query = "SELECT namaadmin FROM admins WHERE username = '$username'";
...
if ($result->num_rows > 0) {
    ...
    // Simpan nama admin dalam variabel
    $nama_admin = $row['namaadmin'];
} else {
...
<head>
  ...
  <title>Tambah Artikel - Agriculate</title>
                ...
                <div class="card">
                  ...
                  <form method="POST" enctype="multipart/form-data" action="">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                      <input type="text" id="penulis" name="penulis" class="form-control" value="<?php echo htmlspecialchars($nama_admin); ?>" readonly>

                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tanggal & Waktu</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="text" id="tanggal_publish" name="tanggal_publish" class="form-control datetimepicker">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <textarea class=" " id="isiartikel" name="konten"></textarea>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
