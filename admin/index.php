...
// Query untuk menghitung jumlah data_mitra
$query = "SELECT COUNT(*) as total_data_mitra FROM data_mitra";
$result = $conn->query($query);
// Mendapatkan hasil query
$row = $result->fetch_assoc();
$totalDataMitra = $row['total_data_mitra'];
...
<head>
  ...
  <title>Dashboard - Agriculate</title>
  <!-- General CSS Files -->
  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Pemilik lahan</h5>
                          <h2 class="mb-3 font-18"><?php echo $totalUsers; ?></h2>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Pemerintah</h5>
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h2 class="mb-3 font-18">48</h2>
                          <p class="mb-0"><span class="col-green">05%</span> Increase</p>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
              ...
              <div class="card ">
                <div class="card-header">
                  ...
                  <div class="card-header-action">
                    <div class="dropdown">
                      <a href="#" data-toggle="dropdown" class="btn btn-warning dropdown-toggle">Pilihan</a>
                      <div class="dropdown-menu">
                        <a href="#" class="dropdown-item has-icon"><i class="fas fa-eye"></i> Lihat</a>
                        <a href="#" class="dropdown-item has-icon"><i class="far fa-edit"></i> Ubaht</a>
                        <div class="dropdown-divider"></div>
                ...
                <div class="card-body">
                  <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                          <div class="list-inline text-center">
                            <div class="list-inline-item p-r-30"><i data-feather="arrow-up-circle"
                                class="col-green"></i>
                              <h5 class="m-b-0">6</h5>
                              <p class="text-muted font-14 m-b-0">Perminggu</p>
                            </div>
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                          <div class="list-inline text-center">
                            <div class="list-inline-item p-r-30"><i data-feather="arrow-down-circle"
                                class="col-orange"></i>
                              <h5 class="m-b-0">5</h5>
                              <p class="text-muted font-14 m-b-0">Perbulan</p>
                            </div>
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                          <div class="list-inline text-center">
                            <div class="list-inline-item p-r-30"><i data-feather="arrow-up-circle"
                              ...
                              <p class="text-muted font-14 m-b-0">Pertahun</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-3">
                      <div class="row mt-5">
                        <div class="col-7 col-xl-7 mb-3">Total pengguna</div>
                        <div class="col-5 col-xl-5 mb-3">
                          <span class="text-big">48</span>
                          <sup class="col-green">+09%</sup>
                        </div>
                        <div class="col-7 col-xl-7 mb-3">Swasta</div>
                        <div class="col-5 col-xl-5 mb-3">
                          <span class="text-big">17</span>
                          <sup class="text-danger">-18%</sup>
                        </div>
                        <div class="col-7 col-xl-7 mb-3">Pemerintah</div>
                        <div class="col-5 col-xl-5 mb-3">
                          <span class="text-big">14</span>
                          <sup class="col-green">+16%</sup>
                        </div>
                        <div class="col-7 col-xl-7 mb-3">Pemilik lahan</div>
                        <div class="col-5 col-xl-5 mb-3">
                          <span class="text-big">17</span>
                          <sup class="col-green">+19%</sup>
                        </div>
                        <div class="col-7 col-xl-7 mb-3">Pengguna Baru</div>
                        <div class="col-5 col-xl-5 mb-3">
                          <span class="text-big">7</span>
      ...
      <footer class="main-footer">
        ...
        <p>&copy; 2023 <strong><span>Agriculate</span></strong>. All Rights Reserved</p></a>
        </div>
