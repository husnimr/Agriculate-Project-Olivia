...
<div class="breadcrumbs">
        <div
          ...
          style="background-image: url('assets/img/page-forum.jpg')"
        >
  ...
  <main id="main">
    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          ...
          <div class="col-md-5">
            <img src="assets/img/forum1.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-md-7">
            <h3>Tujuan Utama</h3>
            <p>
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-5 order-1 order-md-2">
            <img src="assets/img/forum2.jpg" class="img-fluid" alt="">
          </div>
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-5">
            <img src="assets/img/forum3.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-md-7">
            <h3>Alasan</h3>
